(function(){
    'use strict';
    console.log('reading J.S.');

    Parse.initialize("itZqS0XUuM6kSOxra8e8dXS6hAz5yRpTOfdFeOaM", "dA5YjiBIz3sZDDWmm5StZ2B7Ovl0kRJseXjUXdNV"); //PASTE HERE YOUR Back4App APPLICATION ID AND YOUR JavaScript KEY
